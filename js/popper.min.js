/**
 * @popperjs/core v2.4.1 - MIT License
 */
...
!(function (e, t) {
  ...
  function L(e, o) {
    if ("viewport" === o) {
      ...
      o &&
        ...
        (e = k((e = { width: p, height: a, x: l + f(e), y: u })));
  ...
  function H(e, n) {
    ...
    (c = e.rects.popper),
      ...
      (c = k(Object.assign(Object.assign({}, c), p))),
      (f = "popper" === i ? c : f);
    var u = {
          ...
          if (((s = { x: 0, y: 0 }), l)) {
            if (o) {
              ...
              (b = D[b]),
                ...
                (E = c ? d[O] / 2 - M - m - b - h : E - m - b - h),
                (c = c ? -d[O] / 2 + M + m + v + h : f + m + v + h),
